...
def data_cleaning3(dataset_inegi, dataset_benef, prefix):
    ...
    dataset_inegi_clean['KEY_inegi_municipio'] = dataset_inegi_clean['Entidad_c_inegi'].astype(str) + '-' + dataset_inegi_clean[
    'Municipio_c_inegi'].astype(str) 
    dataset_inegi_clean['KEY_inegi_localidad'] = dataset_inegi_clean['Municipio_c_inegi'].astype(str) + '-' + dataset_inegi_clean['Localidad_c_inegi'].astype(str)

    INEGI_UNIQUEMUN = dataset_inegi_clean.drop(columns=["CVE_LOC", "Localidad_inegi", "Localidad_c_inegi", "KEY_inegi_localidad", "POB_TOTAL"])
    ...
    diccionario_MUN.to_csv(f'data/productores_beneficiarios 2019-2022/diccionarios_E3/diccionario_MUN_{prefix}.csv', index=False)

    diccionario_MUN_simple = pd.read_csv(f'data/productores_beneficiarios 2019-2022/diccionarios_E3/diccionario_MUN_{prefix}_simple.csv')
    ...
    listado_beneficiarios_parte_II = pd.merge(listado_beneficiarios_parte_I, INEGI_UNIQUEMUN, left_on="KEY_inegi_municipio",
    ...
    listado_beneficiarios_parte_II['ENTIDAD_c_benef'] = listado_beneficiarios_parte_II['ENTIDAD'].apply(clean_text_inegi)
    listado_beneficiarios_parte_II['MUNICIPIO_c_benef'] = listado_beneficiarios_parte_II['MUNICIPIO'].apply(clean_text_inegi)
    listado_beneficiarios_parte_II['LOCALIDAD_c_benef'] = listado_beneficiarios_parte_II['LOCALIDAD'].apply(clean_text_inegi)

    listado_beneficiarios_parte_II['KEY_benef_loc'] = listado_beneficiarios_parte_II['MUNICIPIO_c_benef'].astype(str) + '-' + listado_beneficiarios_parte_II['LOCALIDAD_c_benef'].astype(str)
    ...
    if prefix == 19:
        ...
        listado_beneficiarios_2019_match['ENTIDAD_c_benef'] = listado_beneficiarios_2019_match['ENTIDAD'].apply(clean_text_inegi)
        listado_beneficiarios_2019_match['MUNICIPIO_c_benef'] = listado_beneficiarios_2019_match['MUNICIPIO'].apply(clean_text_inegi)
        listado_beneficiarios_2019_match['LOCALIDAD_c_benef'] = listado_beneficiarios_2019_match['LOCALIDAD'].apply(clean_text_inegi)
        ...
        Localidades_19_GUERRERO_parte_I = fuzzy_merge_benef2019_2022(listados_beneficiarios_por_entidad['Localidades_19_GUERRERO'], inegi_uniquelocs['INEGI_UNIQUELOC_2019_guerrero'], 'KEY_benef_loc', 'KEY_inegi_localidad')
        Localidades_19_GUERRERO_parte_I.shape

        Localidades_19_PUEBLA_parte_I = fuzzy_merge_benef2019_2022(listados_beneficiarios_por_entidad['Localidades_19_PUEBLA'], inegi_uniquelocs['INEGI_UNIQUELOC_2019_puebla'], 'KEY_benef_loc', 'KEY_inegi_localidad')
        Localidades_19_PUEBLA_parte_I.shape

        Localidades_19_MEXICO_parte_I = fuzzy_merge_benef2019_2022(listados_beneficiarios_por_entidad['Localidades_19_MÉXICO'], inegi_uniquelocs['INEGI_UNIQUELOC_2019_méxico'], 'KEY_benef_loc', 'KEY_inegi_localidad')
        Localidades_19_MEXICO_parte_I.shape

        Localidades_19_GUANAJUATO_parte_I = fuzzy_merge_benef2019_2022(listados_beneficiarios_por_entidad['Localidades_19_GUANAJUATO'], inegi_uniquelocs['INEGI_UNIQUELOC_2019_guanajuato'], 'KEY_benef_loc', 'KEY_inegi_localidad')
        Localidades_19_GUANAJUATO_parte_I.shape

        Localidades_19_QUERETARO_parte_I = fuzzy_merge_benef2019_2022(listados_beneficiarios_por_entidad['Localidades_19_QUERÉTARO'], inegi_uniquelocs['INEGI_UNIQUELOC_2019_querétaro'], 'KEY_benef_loc', 'KEY_inegi_localidad')
        Localidades_19_QUERETARO_parte_I.shape

        Localidades_19_ZACATECAS_parte_I = fuzzy_merge_benef2019_2022(listados_beneficiarios_por_entidad['Localidades_19_ZACATECAS'], inegi_uniquelocs['INEGI_UNIQUELOC_2019_zacatecas'], 'KEY_benef_loc', 'KEY_inegi_localidad')
        Localidades_19_ZACATECAS_parte_I.shape

        Localidades_19_VERACRUZ_DE_IGNACIO_DE_LA_LLAVE_parte_I = fuzzy_merge_benef2019_2022(listados_beneficiarios_por_entidad['Localidades_19_VERACRUZ_DE_IGNACIO_DE_LA_LLAVE'], inegi_uniquelocs['INEGI_UNIQUELOC_2019_veracruz_de_ignacio_de_la_llave'], 'KEY_benef_loc', 'KEY_inegi_localidad')
        Localidades_19_VERACRUZ_DE_IGNACIO_DE_LA_LLAVE_parte_I.shape

        Localidades_19_HIDALGO_parte_I = fuzzy_merge_benef2019_2022(listados_beneficiarios_por_entidad['Localidades_19_HIDALGO'], inegi_uniquelocs['INEGI_UNIQUELOC_2019_hidalgo'], 'KEY_benef_loc', 'KEY_inegi_localidad')
        Localidades_19_HIDALGO_parte_I.shape

        Localidades_19_MICHOACAN_parte_I = fuzzy_merge_benef2019_2022(listados_beneficiarios_por_entidad['Localidades_19_MICHOACÁN_DE_OCAMPO'], inegi_uniquelocs['INEGI_UNIQUELOC_2019_michoacán_de_ocampo'], 'KEY_benef_loc', 'KEY_inegi_localidad')
        Localidades_19_MICHOACAN_parte_I.shape

        Localidades_19_OAXACA_parte_I = fuzzy_merge_benef2019_2022(listados_beneficiarios_por_entidad['Localidades_19_OAXACA'], inegi_uniquelocs['INEGI_UNIQUELOC_2019_oaxaca'], 'KEY_benef_loc', 'KEY_inegi_localidad')
        Localidades_19_OAXACA_parte_I.shape

        Localidades_19_COLIMA_parte_I = fuzzy_merge_benef2019_2022(listados_beneficiarios_por_entidad['Localidades_19_COLIMA'], inegi_uniquelocs['INEGI_UNIQUELOC_2019_colima'], 'KEY_benef_loc', 'KEY_inegi_localidad')
        Localidades_19_COLIMA_parte_I.shape

        Localidades_19_CHIAPAS_parte_I = fuzzy_merge_benef2019_2022(listados_beneficiarios_por_entidad['Localidades_19_CHIAPAS'], inegi_uniquelocs['INEGI_UNIQUELOC_2019_chiapas'], 'KEY_benef_loc', 'KEY_inegi_localidad')
        Localidades_19_CHIAPAS_parte_I.shape

        Localidades_19_POTOSI_parte_I = fuzzy_merge_benef2019_2022(listados_beneficiarios_por_entidad['Localidades_19_SAN_LUIS_POTOSÍ'], inegi_uniquelocs['INEGI_UNIQUELOC_2019_san_luis_potosí'], 'KEY_benef_loc', 'KEY_inegi_localidad')
        Localidades_19_POTOSI_parte_I.shape

        Localidades_19_JALISCO_parte_I = fuzzy_merge_benef2019_2022(listados_beneficiarios_por_entidad['Localidades_19_JALISCO'], inegi_uniquelocs['INEGI_UNIQUELOC_2019_jalisco'], 'KEY_benef_loc', 'KEY_inegi_localidad')
        Localidades_19_JALISCO_parte_I.shape

        Localidades_19_NAYARIT_parte_I = fuzzy_merge_benef2019_2022(listados_beneficiarios_por_entidad['Localidades_19_NAYARIT'], inegi_uniquelocs['INEGI_UNIQUELOC_2019_nayarit'], 'KEY_benef_loc', 'KEY_inegi_localidad')
        ...
        listado_beneficiarios_2019_match['MUNICIPIO_Clean'] = listado_beneficiarios_2019_match['MUNICIPIO'].apply(clean_text_inegi)
        listado_beneficiarios_2019_match['LOCALIDAD_Clean'] = listado_beneficiarios_2019_match['LOCALIDAD'].apply(clean_text_inegi)
       ...
       'Localidad_c_inegi', 'POB_TOTAL'])
        ...
        listado_beneficiarios_2020_match['ENTIDAD_c_benef'] = listado_beneficiarios_2020_match['ENTIDAD'].apply(clean_text_inegi)
        listado_beneficiarios_2020_match['MUNICIPIO_c_benef'] = listado_beneficiarios_2020_match['MUNICIPIO'].apply(clean_text_inegi)
        listado_beneficiarios_2020_match['LOCALIDAD_c_benef'] = listado_beneficiarios_2020_match['LOCALIDAD'].apply(clean_text_inegi)
        ...
        Localidades_20_GUERRERO_parte_I = fuzzy_merge_benef2019_2022(listados_beneficiarios_por_entidad['Localidades_20_GUERRERO'], inegi_uniquelocs['INEGI_UNIQUELOC_2020_guerrero'], 'KEY_benef_loc', 'KEY_inegi_localidad')
        Localidades_20_GUERRERO_parte_I.shape

        Localidades_20_PUEBLA_parte_I = fuzzy_merge_benef2019_2022(listados_beneficiarios_por_entidad['Localidades_20_PUEBLA'], inegi_uniquelocs['INEGI_UNIQUELOC_2020_puebla'], 'KEY_benef_loc', 'KEY_inegi_localidad')
        Localidades_20_PUEBLA_parte_I.shape

        Localidades_20_MORELOS_parte_I = fuzzy_merge_benef2019_2022(listados_beneficiarios_por_entidad['Localidades_20_MORELOS'], inegi_uniquelocs['INEGI_UNIQUELOC_2020_morelos'], 'KEY_benef_loc', 'KEY_inegi_localidad')
        Localidades_20_MORELOS_parte_I.shape

        Localidades_20_TLAXCALA_parte_I = fuzzy_merge_benef2019_2022(listados_beneficiarios_por_entidad['Localidades_20_TLAXCALA'], inegi_uniquelocs['INEGI_UNIQUELOC_2020_tlaxcala'], 'KEY_benef_loc', 'KEY_inegi_localidad')
        ...
        listado_beneficiarios_2020_match['LOCALIDAD_Clean'] = listado_beneficiarios_2020_match['LOCALIDAD'].apply(clean_text_inegi)
       ...
       'Localidad_c_inegi', 'POB_TOTAL'])
        ...
        listado_beneficiarios_parte_II_localidades.drop(columns=['Unnamed: 0', 'ENTIDAD', 'MUNICIPIO', 'LOCALIDAD',
                                                        'ENTIDAD_c_benef', 'MUNICIPIO_c_benef', 'LOCALIDAD_c_benef','KEY_benef_loc_benef', 
                                                        'MUNICIPIO_Clean', 'LOCALIDAD_Clean',
                                                        'Municipio-loc-KEY', 'KEY_benef_loc_inegi', 'match_score',
                                                        'KEY_inegi_localidad', 'KEY_inegi_municipio'], inplace=True)
        ...
        Localidades_21_GUERRERO_parte_I = fuzzy_merge_benef2019_2022(listados_beneficiarios_por_entidad['Localidades_21_GUERRERO'], inegi_uniquelocs['INEGI_UNIQUELOC_2021_guerrero'], 'KEY_benef_loc', 'KEY_inegi_localidad')
        Localidades_21_GUERRERO_parte_I.shape

        Localidades_21_PUEBLA_parte_I = fuzzy_merge_benef2019_2022(listados_beneficiarios_por_entidad['Localidades_21_PUEBLA'], inegi_uniquelocs['INEGI_UNIQUELOC_2021_puebla'], 'KEY_benef_loc', 'KEY_inegi_localidad')
        Localidades_21_PUEBLA_parte_I.shape

        Localidades_21_MORELOS_parte_I = fuzzy_merge_benef2019_2022(listados_beneficiarios_por_entidad['Localidades_21_MORELOS'], inegi_uniquelocs['INEGI_UNIQUELOC_2021_morelos'], 'KEY_benef_loc', 'KEY_inegi_localidad')
        Localidades_21_MORELOS_parte_I.shape

        Localidades_21_TLAXCALA_parte_I = fuzzy_merge_benef2019_2022(listados_beneficiarios_por_entidad['Localidades_21_TLAXCALA'], inegi_uniquelocs['INEGI_UNIQUELOC_2021_tlaxcala'], 'KEY_benef_loc', 'KEY_inegi_localidad')
        ...
        listado_beneficiarios_parte_II['MUNICIPIO_Clean'] = listado_beneficiarios_parte_II['MUNICIPIO'].apply(clean_text_inegi)
        listado_beneficiarios_parte_II['LOCALIDAD_Clean'] = listado_beneficiarios_parte_II['LOCALIDAD'].apply(clean_text_inegi)
       ...
       'Localidad_c_inegi', 'POB_TOTAL'])
        ...
        listado_beneficiarios_parte_II_localidades.drop(columns=['ENTIDAD', 'MUNICIPIO', 'LOCALIDAD', 'KEY_benef_mun',
                                                                ...
                                                                'KEY_inegi_localidad', 'KEY_inegi_municipio', 'ENTIDAD_c_benef','MUNICIPIO_c_benef',
                                                                'LOCALIDAD_c_benef','KEY_benef_loc_benef','KEY_benef_loc_inegi',], inplace=True)
        ...
        Localidades_22_GUERRERO_parte_I = fuzzy_merge_benef2019_2022(listados_beneficiarios_por_entidad['Localidades_22_GUERRERO'], inegi_uniquelocs['INEGI_UNIQUELOC_2022_guerrero'], 'KEY_benef_loc', 'KEY_inegi_localidad')
        Localidades_22_GUERRERO_parte_I.shape

        Localidades_22_PUEBLA_parte_I = fuzzy_merge_benef2019_2022(listados_beneficiarios_por_entidad['Localidades_22_PUEBLA'], inegi_uniquelocs['INEGI_UNIQUELOC_2022_puebla'], 'KEY_benef_loc', 'KEY_inegi_localidad')
        Localidades_22_PUEBLA_parte_I.shape

        Localidades_22_MORELOS_parte_I = fuzzy_merge_benef2019_2022(listados_beneficiarios_por_entidad['Localidades_22_MORELOS'], inegi_uniquelocs['INEGI_UNIQUELOC_2022_morelos'], 'KEY_benef_loc', 'KEY_inegi_localidad')
        Localidades_22_MORELOS_parte_I.shape

        Localidades_22_TLAXCALA_parte_I = fuzzy_merge_benef2019_2022(listados_beneficiarios_por_entidad['Localidades_22_TLAXCALA'], inegi_uniquelocs['INEGI_UNIQUELOC_2022_tlaxcala'], 'KEY_benef_loc', 'KEY_inegi_localidad')
        Localidades_22_TLAXCALA_parte_I.shape

        Localidades_22_DURANGO_parte_I = fuzzy_merge_benef2019_2022(listados_beneficiarios_por_entidad['Localidades_22_DURANGO'], inegi_uniquelocs['INEGI_UNIQUELOC_2022_durango'], 'KEY_benef_loc', 'KEY_inegi_localidad')
        Localidades_22_DURANGO_parte_I.shape

        Localidades_22_OAXACA_parte_I = fuzzy_merge_benef2019_2022(listados_beneficiarios_por_entidad['Localidades_22_OAXACA'], inegi_uniquelocs['INEGI_UNIQUELOC_2022_oaxaca'], 'KEY_benef_loc', 'KEY_inegi_localidad')
        Localidades_22_OAXACA_parte_I.shape

        Localidades_22_NAYARIT_parte_I = fuzzy_merge_benef2019_2022(listados_beneficiarios_por_entidad['Localidades_22_NAYARIT'], inegi_uniquelocs['INEGI_UNIQUELOC_2022_nayarit'], 'KEY_benef_loc', 'KEY_inegi_localidad')
        Localidades_22_NAYARIT_parte_I.shape

        Localidades_22_CHIAPAS_parte_I = fuzzy_merge_benef2019_2022(listados_beneficiarios_por_entidad['Localidades_22_CHIAPAS'], inegi_uniquelocs['INEGI_UNIQUELOC_2022_chiapas'], 'KEY_benef_loc', 'KEY_inegi_localidad')
        Localidades_22_CHIAPAS_parte_I.shape

        Localidades_22_ZACATECAS_parte_I = fuzzy_merge_benef2019_2022(listados_beneficiarios_por_entidad['Localidades_22_ZACATECAS'], inegi_uniquelocs['INEGI_UNIQUELOC_2022_zacatecas'], 'KEY_benef_loc', 'KEY_inegi_localidad')
...
def main():
    data_cleaning3('data/inegi/dataset_inegi_clean_2022.csv', 'data/productores_beneficiarios 2019-2022/fertilizantes_2022.csv', 22)
